...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 1904435956517313725),
      name: 'Note',
      lastPropertyId: const IdUid(3, 7027456421316276123),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 2388904128378000168),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 7830595769570844136),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 7027456421316276123),
            name: 'description',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 1904435956517313725),
